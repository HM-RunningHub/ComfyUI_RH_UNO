...
class Flux(nn.Module):
    ...
    def forward(
        ...
        # print(next(self.double_blocks[0].parameters()).device)
        # print(str(next(self.double_blocks[0].parameters()).device).strip() == 'cpu')

        if str(next(self.double_blocks[0].parameters()).device).strip() == 'cpu':
        ...
        if str(next(self.single_blocks[0].parameters()).device).strip() == 'cpu':
